  ...
  return(
    <div>
      <header       
        ...
        <Navbar />
        <div className="relative pl-10 h-80 py-20 z-0">
          <div className="w-lg h-lg">
            <a href="/">
              <img src={ heroInfo } alt="hero info" className="w-full" />
            </a>
            <p className="text-lg font-light pt-5">Years after retiring from their formidable ninja lives, a dysfunctional family must return to shadowy missions to counteract a string of looming threats.</p>
